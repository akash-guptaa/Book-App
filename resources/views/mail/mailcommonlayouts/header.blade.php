...
<body class="" style="background-color: #edf2f7;color:#000; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; width: 100%;">
	<tr>
		...
		<td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 580px; padding: 10px; width: 580px;">
			<div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 20px;">
				<table role="presentation" class="main" style="border-collpse: separate;  width: 100%; background: #ffffff; border-radius: 10px;box-shadow: 0 5px 10px #0000001c;">
					<tr>
...
<!-- @includes(mailcommonlayouts.footer') -->
